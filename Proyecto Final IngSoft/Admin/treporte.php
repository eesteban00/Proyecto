...
$tickets = "SELECT * FROM Tickets WHERE estado = 2";
$restickets = $conn -> query($tikets);
?>
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu"><li><i class="fa fa fa-tag"></i><a href="tactivos.html">Tickets Activos</a></li>
                            <li><i class="fa fa fa-tag"></i><a href="treporte.php">Reporte de Tickets</a></li>
                            <li><i class="fa fa fa-tag"></i><a href="tbusqueda.html">Busqueda de Tickets</a></li>
                            <li><i class="fa fa fa-tag"></i><a href="tespera.html">Tickets en Espera</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-filter"></i><a href="tables-basic.html">Numero de gestion</a></li>
            ...
            <div class="animated fadeIn">
                ...
                <div class="badges">
                    ...
                    <table border>
                                    ...
                                    <th colspan=2>fecha_solicitud</th>
                                    </tr>
                                    <?php
                                    ...
                                    <td colspan=2>'.$registrotickets['fecha_solicitud'].'</td>
                                    </tr>';
                                    }
                                    ?>
                    </table>
